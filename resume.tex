...
\section{Experience}
  ...
  \resumeSubheading
          {\href{https://www.lambdatest.com/}{LambdaTest}}{August 2024 -- Present}
      {Software Engineer (Open Source) Intern}{Noida, Uttar Pradesh · Hybrid}
      \resumeItemListStart
        \resumeItem{Contributing to open-source testing frameworks like \textbf{Selenium} and \textbf{Appium}}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Fixed \textit{several} checker, parser, scanner, and code generation-related issues in the compiler.}
        ...
        \resumeItem{Documented and developed \textit{several} internal libraries of the language.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Worked on adding new features like  using the Go GUI framework \textbf{Gio}.}
        \resumeItem{Refactored tons of \textbf{CLI} code for \textit{better usability}.}
        \resumeItem{Added \textit{error handling} and \textit{added} new checks and features to improve the functionality.}
        \resumeItem{Worked with \textbf{Svelte} and \textit{made} components like \textbf{left chat panel} which helps to navigate chats.}
    \resumeItemListEnd
